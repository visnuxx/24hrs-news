export const TRANSLATIONS = {
  en: {
    ...
    failedLoad:"Failed to load", backendError:"The free backend may be waking up. Please try again in a moment.",
  ...
  ta: {
    ...
    failedLoad:"ஏற்றல் தோல்வி", backendError:"இலவச பின்தள சேவை தொடங்கிக் கொண்டிருக்கலாம். சிறிது நேரத்தில் மீண்டும் முயற்சிக்கவும்.",
    noArticles:"செய்திகள் இல்லை", tryDifferent:"வேறு வடிகட்டி முயற்சிக்கவும்", tryLater:"பின்னர் முயற்சிக்கவும்",
    articles:"செய்திகள்", updated:"புதுப்பிப்பு",
    poweredByGemini:"Gemini கிடைக்கும் போது சுருக்கப்பட்டது",
    geminiError:"Gemini இப்போது கிடைக்கவில்லை", keywordFallback:"இலவச Gemini quota சேமிக்கப்பட்டது: முக்கியசொல் முறையில் காட்டப்படுகிறது",
